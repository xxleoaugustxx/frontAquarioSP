...
export default function EspecialistaCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Especialista(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "EspecialistaCreateForm")}
      {...rest}
    >
      <TextField
        label="Nome"
